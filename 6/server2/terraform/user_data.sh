...
sudo docker pull 598490276344.dkr.ecr.us-east-1.amazonaws.com/bcit-local:comp4537-lab6-backend
sudo docker run -p 80:3000 -d 598490276344.dkr.ecr.us-east-1.amazonaws.com/bcit-local:comp4537-lab6-backend